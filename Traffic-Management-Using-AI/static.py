        ...
        if self.direction == "right":
            ...
            if self.willTurn == 1:
                if (
                    ...
                    if (
                        self.x + self.currentImage.get_rect().width <= self.stop
                        ...
                        or vehicles[self.direction][self.lane][self.index - 1].turned
                        == 1
                    ):
                        self.x += self.speed
                else:
            ...
            if self.willTurn == 1:
                if (
                    ...
                    if (
                        self.y + self.currentImage.get_rect().height <= self.stop
...
def setTime():
    ...
    os.system(
        "say detecting vehicles, " + directionNumbers[(currentGreen + 1) % noOfSignals]
    )
